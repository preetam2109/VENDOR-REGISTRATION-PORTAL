...
@Component({
  selector: 'app-tender-status-dash-cme',
  standalone: true,
  imports: [
  ...
  templateUrl: './tender-status-dash-cme.component.html',
  styleUrl: './tender-status-dash-cme.component.css'
})
export class TenderStatusDashCmeComponent {
  ...
  this.api.GetTotalRC1Details(this.mcid,value).subscribe({
    next: (res: any[]) => {
      if (res && res.length > 0) {
        ...
        this.dataSource12.data = this.totalRC1details;
