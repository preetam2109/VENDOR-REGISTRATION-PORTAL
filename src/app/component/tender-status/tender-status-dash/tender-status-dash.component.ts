...
@Component({
  ...
  templateUrl: './tender-status-dash.component.html',
...
export class TenderStatusDashComponent {
  ...
  applyTextFilter3($event: KeyboardEvent) {
    ...
    cardColors: string[] = [
      ...
      pageName: string = '';
      fullUrl: string = '';
      constructor(public toastr: ToastrService,private spinner: NgxSpinnerService,private location: Location,
    ...
    loadUQC(): void {
      ...
      loadData2(): void {
          ...
          getstatusDetails() {
            ...
            this.api.getStatusDetail(this.status, this.mcid).subscribe({
              next: (res: any[]) => {
                if (res && res.length > 0) {
