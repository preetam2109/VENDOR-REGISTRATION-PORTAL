...
@Component({
  selector: 'app-confirm-product-permission-tab',
  standalone: true,
  ...
  templateUrl: './confirm-product-permission-tab.html',
  styleUrl: './confirm-product-permission-tab.css'
})
export class ConfirmProductPermissionTab {
