...
@Component({
  selector: 'app-confirm-market-standing-certificate-tab',
  standalone:true,
  ...
  templateUrl: './confirm-market-standing-certificate-tab.html',
  styleUrl: './confirm-market-standing-certificate-tab.css'
})
export class ConfirmMarketStandingCertificateTab {
