...
@Component({
  ...
  templateUrl: './dhsdash.component.html',
  styleUrl: './dhsdash.component.css'
})
export class DhsdashComponent {
exportToPDF() {
...
colors = [];
  ...
  constructor(private spinner: NgxSpinnerService, 
    private dialog: MatDialog,private api: ApiService,private menuService: MenuServiceService,private location: Location,
    private authService: HardcodedAuthenticationService,public basicAuthentication: BasicAuthenticationService,public router:Router) {
