...
@Component({
  selector: 'app-dme-fac-noc-summary',
  standalone: true,
  ...
  templateUrl: './dme-fac-noc-summary.component.html',
  styleUrl: './dme-fac-noc-summary.component.css'
})
export class DmeFacNocSummaryComponent {
  mcid=1
