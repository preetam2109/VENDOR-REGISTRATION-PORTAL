...
@Component({
  selector: 'app-cgmsc-supplies-dme',
  standalone: true,
  ...
  templateUrl: './cgmsc-supplies-dme.component.html',
  styleUrl: './cgmsc-supplies-dme.component.css'
})
export class CgmscSuppliesDmeComponent {
...
mcid:any='1';
  constructor(
    ...
    this.chartOptionsLine = {
      ...
      title: {
        text: 'Total No of Drugs Supplied against DME fixed Annual Indent',
        align: 'center',
      },
      fill: {
        opacity: 1,
    ...
    this.chartOptions2 = {
      ...
      title: {
        text: 'Current Year Medical Colleges/Hospitals Consumables Supplied',
        align: 'center',
      },
      fill: {
        opacity: 1,
    ...
    this.chartOptionsLine2 = {
      ...
      title: {
        text: 'Total No of Consumables Supplied against DME fixed Annual Indent',
        align: 'center',
      },
      fill: {
        opacity: 1,
